export const installed_blueprints = [
  //@BlueprintInsertion
{ name: 'EmailAuth4184', human_name: 'Email Auth', access_route: 'EmailAuth4184', icon: 'envelope-o'},
{ name: 'UserProfile4183', human_name: 'User Profile', access_route: 'UserProfile4183'},
